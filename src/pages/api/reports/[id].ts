// src/pages/api/reports/update/[id].ts
...
async function updateReportHandler(req: NextApiRequest, res: NextApiResponse) {
  if (req.method !== 'PUT') {
...
export default createSecureHandler(updateReportHandler, {
  requireAuth: true,
});